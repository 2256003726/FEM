...
public class JpushClientUtil {
	 ...
	 //AppKey 为极光平台应用的唯一标识。
	 private final static String APPKER = "da37fa7a3226fc41171e4855";
	 //用于服务器端 API 调用时与 AppKey 配合使用达到鉴权的目的，请保管好 Master Secret 防止外泄。
	 private final static String MASTERSECRET = "a6b6d256ef7c4a8f78d98240";
